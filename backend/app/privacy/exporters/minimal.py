...
class MinimalSubjectDataExporter(SubjectDataExporter):
    def export_subject_data(self, context: ExportContext) -> dict[str, object]:
        return {
            ...
            "subject_user_id": str(context.subject_user_id) if context.subject_user_id else None,
            "requester_user_id": str(context.requester_user_id) if context.requester_user_id else None,
