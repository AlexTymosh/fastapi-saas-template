    ...
    PrivacyTableInventoryEntry(
        ...
        fields=(
            ...
            PrivacyFieldInventory(
                ...
                True,
                PrivacyFieldErasureAction.RETAIN,
                "Current DSR execution state, separate from review status.",
            ),
            PrivacyFieldInventory(
                ...
                True,
                PrivacyFieldErasureAction.RETAIN,
                "Timestamp proving when DSR execution started.",
            ),
            PrivacyFieldInventory(
                ...
                True,
                PrivacyFieldErasureAction.RETAIN,
                "Timestamp proving when DSR execution completed.",
            ),
            PrivacyFieldInventory(
                "execution_failed_at",
                PrivacyFieldClassification.LIFECYCLE,
                True,
                PrivacyFieldErasureAction.RETAIN,
                "Timestamp proving when DSR execution failed.",
            ),
            PrivacyFieldInventory(
                ...
                True,
                PrivacyFieldErasureAction.RETAIN_MINIMISED,
                "Structured execution failure reason for compliance review.",
            ),
            PrivacyFieldInventory(
                ...
                False,
                PrivacyFieldErasureAction.REVIEW_REQUIRED,
                "Internal failure detail may contain personal data; do not export.",
            ),
            PrivacyFieldInventory(
                "requester_user_id",
                PrivacyFieldClassification.INDIRECT_IDENTIFIER,
            ...
            PrivacyFieldInventory(
                ...
                True,
                PrivacyFieldErasureAction.RETAIN,
                "Whether the requester acts for self or as representative.",
            ),
            PrivacyFieldInventory(
                ...
                True,
                PrivacyFieldErasureAction.RETAIN,
                "Representative verification lifecycle state.",
            ),
            PrivacyFieldInventory(
                ...
                True,
                PrivacyFieldErasureAction.REVIEW_REQUIRED,
                "Requester-supplied relationship context for review.",
            ),
            PrivacyFieldInventory(
                ...
                True,
                PrivacyFieldErasureAction.REVIEW_REQUIRED,
                "Requester-supplied authority details for review.",
            ),
            PrivacyFieldInventory(
                ...
                True,
                PrivacyFieldErasureAction.RETAIN,
                "Representative verification timestamp.",
            ),
            PrivacyFieldInventory(
                ...
                True,
                PrivacyFieldErasureAction.RETAIN_MINIMISED,
                "Platform reviewer link for representative verification.",
            ),
            PrivacyFieldInventory(
                ...
                True,
                PrivacyFieldErasureAction.RETAIN_MINIMISED,
                "Structured representative authority rejection reason.",
            ),
            PrivacyFieldInventory(
                "submitted_at",
                PrivacyFieldClassification.LIFECYCLE,
