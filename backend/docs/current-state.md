...
- Platform staff, permissions, current platform identity endpoint foundation, limited platform user/organisation/audit views, and filtered full platform list views for future admin frontend clients.
...
- Full contract/security test coverage beyond the current platform OpenAPI contract, platform full-list filter tests, and platform permission matrix tests.
