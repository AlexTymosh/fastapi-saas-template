...
The current foundation prepares rate-limit metrics through no-op OpenTelemetry API instruments. This keeps runtime behavior stable while making metric hooks available for future telemetry wiring.
