...
6. External JWT role claims (`roles`, `realm_access`, `resource_access`) must never grant request-time backend authorization; they may only be considered in the future as controlled JIT provisioning input for local DB records.
