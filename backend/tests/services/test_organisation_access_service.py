...
def test_list_memberships_for_member_organisation_uses_single_access_use_case() -> None:
    ...
    service.membership_service = AsyncMock()
    service.membership_service.ensure_user_has_organisation_role = AsyncMock()
    ...
    service.membership_service.ensure_user_has_organisation_role.assert_awaited_once_with(
        user_id=user.id,
        organisation_id=organisation_id,
