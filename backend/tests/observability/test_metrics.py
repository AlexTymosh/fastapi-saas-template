...
def test_inmemory_metric_reader_smoke_collects_expected_metric_names() -> None:
    ...
    meter = provider.get_meter("tests.observability")
...
def test_metrics_helpers_emit_only_low_cardinality_attributes(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        rate_limit_metrics, "rate_limit_requests_total", requests_counter
    )
    monkeypatch.setattr(
        rate_limit_metrics, "rate_limit_backend_errors_total", backend_counter
    )
    monkeypatch.setattr(
        rate_limit_metrics, "rate_limit_check_duration", duration_histogram
    )
...
def test_record_rate_limit_decision_does_not_raise_when_counter_fails(
    ...
    monkeypatch.setattr(
        rate_limit_metrics, "rate_limit_requests_total", _RaisingCounter()
    )
...
def test_record_rate_limit_backend_error_does_not_raise_when_counter_fails(
    ...
    monkeypatch.setattr(
        rate_limit_metrics, "rate_limit_backend_errors_total", _RaisingCounter()
    )
...
def test_record_rate_limit_check_duration_does_not_raise_when_histogram_fails(
    ...
    monkeypatch.setattr(
        rate_limit_metrics, "rate_limit_check_duration", _RaisingHistogram()
    )
